...
function DatenschutzContentDE() {
  return (
    <>
      <h1 className="text-3xl md:text-4xl font-bold mb-12">Datenschutzerklärung</h1>
      ...
      <div className="space-y-10 text-muted-foreground">
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h4 className="font-medium text-foreground mt-4 mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
              <p>
                Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten
                können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle" in dieser Datenschutzerklärung entnehmen.
              </p>

              <h4 className="font-medium text-foreground mt-4 mb-2">Wie erfassen wir Ihre Daten?</h4>
              <p>
              ...
              <h4 className="font-medium text-foreground mt-4 mb-2">Wofür nutzen wir Ihre Daten?</h4>
              <p>
              ...
              <h4 className="font-medium text-foreground mt-4 mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
              <p>
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2">
                Maximilian Weigel<br />
                Berthold Schwarz Straße 8<br />
                13599 Berlin<br />
                Deutschland
              </p>
              <p className="mt-2">
                Telefon: 017620189873<br />
                E-Mail: maxweigel087@gmail.com
              </p>
              <p className="mt-2">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Empfänger von personenbezogenen Daten</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Auskunft, Berichtigung und Löschung</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Recht auf Einschränkung der Verarbeitung</h3>
              <p>
        ...
        <section>
          ...
          <div>
            <h3 className="text-lg font-medium text-foreground mb-2">Google Fonts (lokales Hosting)</h3>
            <p>
...
function DatenschutzContentEN() {
  return (
    <>
      <h1 className="text-3xl md:text-4xl font-bold mb-12">Privacy Policy</h1>
      ...
      <div className="space-y-10 text-muted-foreground">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p>
                ...
                information on data protection, please refer to our privacy policy listed below.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Data Collection on This Website</h3>
              
              <h4 className="font-medium text-foreground mt-4 mb-2">Who is responsible for data collection on this website?</h4>
              <p>
              ...
              <h4 className="font-medium text-foreground mt-4 mb-2">How do we collect your data?</h4>
              <p>
                Your data is collected when you provide it to us. This may include data you enter in a contact form, 
                for example.
              </p>
              <p className="mt-2">
                Other data is automatically collected or collected with your consent when you visit the website by our 
                IT systems. This primarily includes technical data (e.g., internet browser, operating system, or time 
                of page access). This data is collected automatically as soon as you enter this website.
              </p>

              <h4 className="font-medium text-foreground mt-4 mb-2">What do we use your data for?</h4>
              <p>
                Some of the data is collected to ensure error-free provision of the website. Other data may be used 
                to analyze your user behavior. If contracts can be concluded or initiated via the website, the 
                transmitted data will also be processed for contract offers, orders, or other order inquiries.
              </p>

              <h4 className="font-medium text-foreground mt-4 mb-2">What rights do you have regarding your data?</h4>
              <p>
                ...
                at any time for the future. You also have the right to request the restriction of the processing 
                of your personal data under certain circumstances. Furthermore, you have the right to lodge a 
        ...
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">2. Hosting</h2>
          <p className="mb-4">We host the contents of our website with the following provider:</p>
          
          <div>
            <h3 className="text-lg font-medium text-foreground mb-2">External Hosting</h3>
            <p>
              This website is hosted externally. The personal data collected on this website is stored on the 
              servers of the host(s). This may include IP addresses, contact requests, meta and communication 
            ...
            <p className="mt-2">
              Our host(s) will only process your data to the extent necessary to fulfill their service obligations 
              and follow our instructions regarding this data.
            </p>
            <p className="mt-4">We use the following host(s):</p>
            <p className="mt-2">
              united-domains GmbH<br />
              Gautinger Straße 10<br />
              82319 Starnberg<br />
        ...
        {/* Section 3 */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">3. General Information and Mandatory Disclosures</h2>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2">
                ...
                email) may have security gaps. Complete protection of data against access by third parties is not 
                possible.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Information about the Responsible Party</h3>
              ...
              <p className="mt-2">
                Phone: +49 176 20189873<br />
                Email: maxweigel087@gmail.com
              </p>
              <p className="mt-2">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Storage Duration</h3>
              <p>
                Unless a more specific storage period has been specified within this privacy policy, your personal 
                data will remain with us until the purpose for data processing no longer applies. If you assert a 
                ...
                commercial law retention periods); in the latter case, deletion will occur after these reasons 
                no longer apply.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Revocation of Your Consent to Data Processing</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Right to Lodge a Complaint with the Competent Supervisory Authority</h3>
              <p>
                In the event of violations of the GDPR, data subjects have the right to lodge a complaint with a 
                supervisory authority, in particular in the Member State of their habitual residence, their place 
                of work, or the place of the alleged violation. The right to lodge a complaint exists without 
            ...
            <div>
              ...
              <p>
                ...
                format. If you request the direct transfer of the data to another controller, this will only be 
                done to the extent technically feasible.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Information, Correction, and Deletion</h3>
              <p>
                Within the framework of the applicable legal provisions, you have the right to free information 
                about your stored personal data, its origin and recipients, and the purpose of data processing 
                and, if applicable, a right to correction or deletion of this data at any time. You can contact 
                us at any time regarding this and other questions on the subject of personal data.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium text-foreground mb-2">Right to Restriction of Processing</h3>
              <p>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <li>If the processing of your personal data was/is unlawful, you can request the restriction of 
                data processing instead of deletion.</li>
                <li>If we no longer need your personal data, but you need it for the exercise, defense, or 
                assertion of legal claims, you have the right to request the restriction of the processing 
                of your personal data instead of deletion.</li>
                <li>If you have lodged an objection pursuant to Art. 21 para. 1 GDPR, a balance must be struck 
                between your interests and ours. As long as it has not yet been determined whose interests 
                prevail, you have the right to request the restriction of the processing of your personal data.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        {/* Section 4 */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">4. Data Collection on This Website</h2>
          
          <div>
            <h3 className="text-lg font-medium text-foreground mb-2">Cookies</h3>
            <p>
              Our websites use so-called "cookies". Cookies are small data packages and do not cause any damage 
              to your device. They are stored either temporarily for the duration of a session (session cookies) 
              or permanently (permanent cookies) on your device. Session cookies are automatically deleted after 
              your visit. Permanent cookies remain stored on your device until you delete them yourself or they 
            ...
            <p className="mt-2">
              Cookies have various functions. Many cookies are technically necessary because certain website 
              functions would not work without them (e.g., the shopping cart function or the display of videos). 
              Other cookies can be used to evaluate user behavior or for advertising purposes.
            </p>
            <p className="mt-2">
              Cookies that are required for the electronic communication process, for providing certain functions 
              you want (e.g., for the shopping cart function), or for optimizing the website (e.g., cookies for 
              measuring web audience) (necessary cookies) are stored on the basis of Art. 6 para. 1 lit. f GDPR, 
              unless another legal basis is specified.
            </p>
            <p className="mt-2">
              You can set your browser to inform you about the setting of cookies and only allow cookies in 
              individual cases, exclude the acceptance of cookies for certain cases or in general, and activate 
              the automatic deletion of cookies when closing the browser. If cookies are deactivated, the 
        ...
        {/* Section 5 */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">5. Plugins and Tools</h2>
          
          <div>
            <h3 className="text-lg font-medium text-foreground mb-2">Google Fonts (Local Hosting)</h3>
            <p>
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20">
        <div className="section-container max-w-3xl">
          {language === 'en' ? <DatenschutzContentEN /> : <DatenschutzContentDE />}
        </div>
      </main>
      <Footer />
    </div>
